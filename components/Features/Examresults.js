...
const Examresults = ({ query }) => {
    ...
    const animatedText = `You haven't written any ${semesterCode} exams ...`;
        ...
        <>
            ...
            <div className="m-2 text-[45%] sm:text-[60%] md:text-[80%] lg:text-[100%]">
                ...
                {Object.keys(query['Results']).map((semesterKey) => {
                    ...
                    return (
                        <div key={semesterKey}>
                            {Object.keys(semesterResults)
                                .slice(-1) // Select the last object
                                .map((examKey) => {
                                    const examResults = semesterResults[examKey];
                                    ...
                                    return (
                                        <div key={examKey}>
                                            ...
                                            <Link href="/SemResults">
                                                ...
                                                <center>
                                                    <button className="bg-green-500 hover:bg-white text-white hover:text-green-500 rounded-xl px-3 py-2 shadow-lg flex items-center font-bold text-sm">
                                                        View SGPA
                                                    </button></center>
                                            </Link>
                                            ...
                                            {/* <center>
                                                <table>
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                % of Marks Secured in a Subject / Course (Class Intervals)</th>
                                                            <th>Letter Grade (UGC Guide Lines)</th>
                                                            <th>Grade Points (G)</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <th>Greater than or equal to 90%</th>
                                                            <th>O (Outstanding)</th>
                                                            <th>10</th>
                                                        </tr>
                                                        <tr>
                                                            <th>80% and Less than 90%</th>
                                                            <th>A+ (Excellent)</th>
                                                            <th>9</th>
                                                        </tr>
                                                        <tr>
                                                            <th>70% and Less than 80%</th>
                                                            <th>A (Very Good)</th>
                                                            <th>8</th>
                                                        </tr>
                                                        <tr>
                                                            <th>60% and Less than 70%</th>
                                                            <th>B+ (Good)</th>
                                                            <th>7</th>
                                                        </tr>
                                                        <tr>
                                                            <th>50% and Less than 60%</th>
                                                            <th>B (Average)</th>
                                                            <th>6</th>
                                                        </tr>
                                                        <tr>
                                                            <th>40% and Less than 50%</th>
                                                            <th>C (Pass)</th>
                                                            <th>5</th>
                                                        </tr>
                                                        <tr>
