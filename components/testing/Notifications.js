...
// import Notification from './definedTypes';
...
//   const url = refresh ? 'https://results-restapi.up.railway.app/notifications?refresh=true' : 'https://results-restapi.up.railway.app/notifications';
...
//     methods: ['GET'],
//   };
//   const response = await axios.get(url, { headers: cors(), corsOptions });
