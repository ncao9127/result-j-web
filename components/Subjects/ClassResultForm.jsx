...
import data from '../ClassResult/colleges';
import branches from '../ClassResult/branches';
    ...
    return (
        <div >
            <div className="w-[75%] mx-[12.5%] md:w-[66%] md:mx-[17%] ">
                <div className="mx-[0.25%] border-black shadow-2xl rounded-lg">
                    <center className="py-[35px]">
                        ...
                        <p>
                            Performance Of Class Subjects Stats Ratio For A Particular Semester
                        </p>
                        <br />
