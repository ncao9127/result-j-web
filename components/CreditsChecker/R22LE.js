...
const R22LE = ({ query }) => {
  ...
  switch (lastVal) {
    case '2-1':
      message = `You are currently in your 2nd Year 2nd Semester and you require ${24 - totalCredits} specific extra credits to meet the eligibility criteria for the 3rd Year 1st Semester`;
      break;
    case '2-2':
      if (totalCredits >= 24) {
        SemStatus = "Eligible"
        ...
        message = `You need ${24 - totalCredits} specific extra credits to be eligible for 3rd Year 1st Semester`;
      }
      break;
    case '3-1':
      message = `You are currently in your 3rd Year 2nd Semester and you require ${48 - totalCredits} specific extra credits to meet the eligibility criteria for the 4th Year 1st Semester`;
      break;
    case '3-2':
      if (totalCredits >= 48) {
        SemStatus = "Eligible"
        ...
        SemStatus = "Not Eligible"
        message = `You need ${48 - totalCredits} specific extra credits to be eligible for 4th Year 1st Semester`;
      }
      break;
    case '4-1':
