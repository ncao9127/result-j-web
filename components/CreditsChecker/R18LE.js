  ...
  switch (lastVal) {
    ...
    case '2-2':
      if (totalCredits >= 25) {
        ...
        message = `You need ${25 - totalCredits} specific extra credits to be eligible for 3rd Year 1st Semester`;
      }
      break;
    case '3-1':
    ...
    case '3-2':
      if (totalCredits >= 51) {
        ...
        SemStatus = "Not Eligible"
        message = `You need ${51 - totalCredits} specific extra credits to be eligible for 4th Year 1st Semester`;
      }
      break;
    case '4-1':
