...
import Resultsanalysis from "../components/Backlogsoverview/Resultsanalysis";
...
const Backlogsoverview = ({ homepage }) => {
            ...
            try {
                ...
                if (storedData) {
                    ...
                    if (expiryTimestamp && expiryTimestamp > Date.now()) {
                        homepage(<Resultsanalysis query={data} />);
                        return;
                    } else {
...
const HomePage = () => {
    ...
    const [content, setContent] = useState(<Backlogsoverview homepage={homepage} />);
