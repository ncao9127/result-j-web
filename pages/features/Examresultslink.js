        ...
        <div key="notification">
            {isLoading ? (
                ...
                <div>
                    ...
                    <div className=' pt-[75px] hidden md:block font-interer'>
                        <div className='max-w-[800px] justify-center mx-auto'>

                            <h1 className="text-3xl font-semibold text-center mb-8 ">Exam Results Link</h1>
                            ...
                            <div className="home-links flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full text-center  justify-center mx-auto">
                                {filteredResults.map((result, index) => (
                                    <a key={index} href={result.Link} target='_blank' rel="noreferrer">

                                        <div className="border border-gray-100 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:drop-shadow-sm group text-black shadow-2xl max-w-xs p-6 mt-6 text-left md:w-96 rounded-xl hover:border-gray-500" >
                                            <h3 className=" dark:text-white text-lg sm:text-xl font-bold">
                                                <div className="flex flex-row items-center justify-start">
                                                    <span className="p-1">{result.Result_title}</span>

                                                </div>
                                            </h3>
                                            <p className="group-hover:text-black text-slate-500 dark:text-gray-400  mt-4 text-base sm:text-xl"> {result.Date}</p>
                                        </div>
                                    </a>
                                ))}
                    ...
                    <h1 className="text-3xl font-semibold text-center pt-[75px] mb-8 font-interer md:hidden">Exam Results Link</h1>
                    {results.map((result, index) => (
                        <div key={index} className='bg-[white]  hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-left p-[20px] mb-[3px] pb-[5px] md:hidden'>
